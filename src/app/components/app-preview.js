...
const AppPreview = () => {
    return (
        <div className="bg-slate-800 px-[16px] gap-5 flex flex-col py-10 lg:py-[50px] lg:px-[80px]">
            ...
            <div className="flex justify-end">
                <p className="lg:w-[400px] text-right text-lime-50 text-sm font-medium font-cabinet leading-tight">Farmiz helps you make the best agricultural-related investment decisions and achieve lasting financial success.</p>
            </div>
