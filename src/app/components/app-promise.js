...
const AppPromise = () => {
    return (
        <div className="w-full flex bg-violet-300 flex-col px-[16px] justify-center items-center py-10">
            ...
            <div className="lg:flex-row flex gap-10 justify-normal items-center  lg:px-[80px] flex-col w-full">
